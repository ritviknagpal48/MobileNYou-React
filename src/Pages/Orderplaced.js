            ...
            <div class="badydiv">
                <div class="universalDiv graybg" style={{ backgroundColor: "#F5F5F5" }}>
                    ...
                    <section class="bodypanelmian">
                        <div style={{display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"column",marginTop:"1rem",backgroundColor:"white",boxShadow: "0px 0px 4px 1px gainsboro",backgroundImage:"url(/icons/party.png)"}}>
                        ...
                        <div style={{display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"column",marginTop:"55%"}}>
