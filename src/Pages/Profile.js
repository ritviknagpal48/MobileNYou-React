            ...
            <div class="badydiv">
                <div class="universalDiv" style={{height: '100vh', backgroundColor: '#f5f5f5'}}>
                    ...
                    <div style={{margin:"0.7rem 0"}}>
                        ...
                        <input className="form-control input-tag-for-focus" style={{ backgroundColor: "white", padding: "7% 3%", borderRadius: "5px", border: "1px solid gainsboro", width: "95%",margin:"0 auto",marginBottom:"0.7rem"}} placeholder="Email / Contact No." id="email-password-input-box"></input>

                        <label style={{fontSize:"11px",color:"grey",marginLeft:"0.8rem"}} for="email-password-input-box">Email ID</label> 
                        <input disabled className="form-control input-tag-for-focus" style={{ backgroundColor: "##F5F5F5", padding: "7% 3%", borderRadius: "5px", border: "1px solid gainsboro", width: "95%",margin:"0 auto",marginBottom:"0.7rem"}} placeholder="nesh.28feb@gmail.com" id="email-password-input-box"></input>
